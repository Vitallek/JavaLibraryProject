...
import "./Dnd.scss";
import { ProcessInvoice } from "./ProcessInvoice.js";

export default function InvoiceDrop({setDoc, isDocLoaded, setIsDocLoaded}) {
    ...
    function processExcel(data) {
        ...
        setDoc(ProcessInvoice(excelRows1))
    }
    ...
    return (
        <div className="container">
            {!isDocLoaded 
            ? 
            <h3>{`Загрузите накладную`}</h3> 
            : 
            <h3>{`накладная загружена ${new Date().toLocaleString()}`}</h3>}
