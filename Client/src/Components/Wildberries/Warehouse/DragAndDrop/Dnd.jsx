...
import ProcessPremPrice from "../Utility/ProcessPremPrice.js";

import "./Dnd.scss";

export default function Dnd({setPremPrice, isPriceLoaded, setIsPriceLoaded}) {
    ...
    function processExcel(data) {
        ...
        setPremPrice(ProcessPremPrice(excelRows1))
    }
    ...
    return (
        <div className="container">
            {!isPriceLoaded ? <h3>{`Загрузите <остатки>.XLSX`}</h3> : <h3>{`Остатки загружены ${new Date().toLocaleString()}`}</h3>}
